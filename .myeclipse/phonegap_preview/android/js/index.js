...
function openSite()
{
    console.log('into function openSite()');
//    console.log('CORDOVA: ' + cordova);
//    console.log(JSON.stringify(cordova, null, 4));
//    console.log(JSON.stringify(cordova.InAppBrowser, null, 4));
//    console.log(JSON.stringify(cordova.callbacks, null, 4));
